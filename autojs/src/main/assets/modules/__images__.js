...
module.exports = function (runtime, scope) {
    ...
    with (images.opencvImporter) {
        ...
        images.requestScreenCapture = function (landscape) {
            let ScreenCapturer = com.stardust.atjs.core.image.capture.ScreenCapturer;
        ...
        function getColorDetector(color, algorithm, threshold) {
            switch (algorithm) {
                case "rgb":
                    return new com.stardust.atjs.core.image.ColorDetector.RGBDistanceDetector(color, threshold);
                case "equal":
                    return new com.stardust.atjs.core.image.ColorDetector.EqualityDetector(color);
                case "diff":
                    return new com.stardust.atjs.core.image.ColorDetector.DifferenceDetector(color, threshold);
                case "rgb+":
                    return new com.stardust.atjs.core.image.ColorDetector.WeightedRGBDistanceDetector(color, threshold);
                case "hs":
                    return new com.stardust.atjs.core.image.ColorDetector.HSDistanceDetector(color, threshold);
            }
