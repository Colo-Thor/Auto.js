module.exports = function (runtime, global) {
    ...
    ui.inflate = function(xml, parent, attachToParent){
        ...
        let ctx;
        if(typeof(activity) == 'undefined') {
            ctx = new android.view.ContextThemeWrapper(context, com.stardust.atjs.R.style.ScriptTheme);
        } else {
            ctx = activity;
        }
    ...
    ui.findByStringId = function (view, id) {
        return com.stardust.atjs.core.ui.JsViewHelper.findViewByStringId(view, id);
    }
    ...
    layoutInflater.setLayoutInflaterDelegate({
        ...
        afterCreateView: function (context, view, node, viewName, parent, attrs) {
            if (view.getClass().getName() == "com.stardust.atjs.core.ui.widget.JsListView" ||
                view.getClass().getName() == "com.stardust.atjs.core.ui.widget.JsGridView") {
                initListView(view);
            }
            ...
            if(widget != null){
                widget.view = view;
                view.widget = widget;
                let viewAttrs = com.stardust.atjs.core.ui.ViewExtras.getViewAttributes(view, layoutInflater.resourceParser);
