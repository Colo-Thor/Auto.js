package com.stardust.atjs.core.floaty;
...
public class AccessibilityFloatyService extends FloatyService {
    ...
    public void onCreate() {
        ...
        if (AbService.Companion.getInstance() != null) {
            this.mWindowManager = AbService.Companion.getInstance().getWindowManager();
        }
    ...
    public IBinder onBind(Intent intent) {
        ...
        return AbService.Companion.getInstance().onBind(intent);
    }
