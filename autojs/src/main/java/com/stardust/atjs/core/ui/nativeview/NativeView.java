package com.stardust.atjs.core.ui.nativeview;
...
import com.stardust.atjs.rhino.NativeJavaObjectWithPrototype;
...
public class NativeView extends NativeJavaObjectWithPrototype {
    ...
    public NativeView(Scriptable scope, View view, Class<?> staticType, com.stardust.atjs.runtime.ScriptRuntime runtime) {
