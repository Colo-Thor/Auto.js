...
import com.stardust.atjs.inrt.LogActivity
import com.stardust.atjs.inrt.Pref
import com.stardust.atjs.inrt.R
import com.stardust.atjs.inrt.SettingsActivity
...
class AutoJs private constructor(application: Application) : com.stardust.atjs.AutoJs(application) {
