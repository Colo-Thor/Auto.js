...
public class ExplorerItemList {
    ...
    public static class SortConfig {
        ...
        private static final String CLASS_NAME = "com.debin.atjs.ui.viewmodel.ScriptList.SortConfig";
