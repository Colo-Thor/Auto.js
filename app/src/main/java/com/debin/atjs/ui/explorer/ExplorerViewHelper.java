...
public class ExplorerViewHelper {
    ...
    public static String getDisplayName(ExplorerItem item) {
        ...
        if (type.equals(ExplorerItem.TYPE_JAVASCRIPT) || type.equals(ExplorerItem.TYPE_AUTO_FILE)) {
    ...
    public static String getIconText(ExplorerItem item) {
        String type = item.getType();
        if (type.isEmpty()) {
            return ExplorerItem.TYPE_UNKNOWN;
        }
        if (type.equals(ExplorerItem.TYPE_AUTO_FILE)) {
            return "R";
        }
    ...
    public static int getIconColor(ExplorerItem item) {
        switch (item.getType()) {
            case ExplorerItem.TYPE_JAVASCRIPT:
                return getColor(GlobalAppContext.get(), R.color.color_j);
            case ExplorerItem.TYPE_AUTO_FILE:
