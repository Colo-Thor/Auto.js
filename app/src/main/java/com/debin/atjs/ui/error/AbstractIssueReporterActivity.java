package com.debin.atjs.ui.error;
...
public abstract class AbstractIssueReporterActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.debin.atjs.R.layout.air_activity_issue_reporter);
        findViews();
    ...
    private void initViews() {
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle(com.debin.atjs.R.string.text_issue_report);
        }
    ...
    public void finish() {
        if (mCrash) {
            if (!mReportFailed) {
                Toast.makeText(this, com.debin.atjs.R.string.text_report_succeed, Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(this, com.debin.atjs.R.string.text_report_fail, Toast.LENGTH_SHORT).show();
            }
            finishAffinity();
        } else {
            super.finish();
