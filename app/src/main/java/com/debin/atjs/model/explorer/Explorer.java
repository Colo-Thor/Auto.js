package com.debin.atjs.model.explorer;
...
public class Explorer {
    ...
    public void notifyChildrenChanged(ExplorerPage page) {
        clearCache(page);
        mEventBus.post(new ExplorerChangeEvent(page, ExplorerChangeEvent.CHILDREN_CHANGE, null));
    }
    ...
    public void notifyItemChanged(ExplorerItem oldItem, ExplorerItem newItem) {
        ...
        mEventBus.post(new ExplorerChangeEvent(parent, ExplorerChangeEvent.CHANGE, oldItem, newItem));
    }
    ...
    public void notifyItemRemoved(ExplorerItem item) {
        ...
        mEventBus.post(new ExplorerChangeEvent(parent, ExplorerChangeEvent.REMOVE, item));
    }
    ...
    public void notifyItemCreated(ExplorerItem item) {
        ...
        mEventBus.post(new ExplorerChangeEvent(parent, ExplorerChangeEvent.CREATE, item, item));
    }
